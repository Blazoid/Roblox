...
function Library:CreateWindow(...)
	...
	local TabAreaBack = Library:Create('Frame', {
		BackgroundColor3 = Library.BackgroundColor;
		BorderColor3 = Library.OutlineColor;
        Position = UDim2.new(0, 0, 0, 0);
		BorderSizePixel = 1;
	...
	Library:AddToRegistry(TabAreaBack, {
        BackgroundColor3 = 'BackgroundColor';
		BorderColor3 = 'OutlineColor';
    });
    ...
    local TabContainer = Library:Create('Frame', {
		...
		BackgroundTransparency = 1,
        BorderColor3 = Library.OutlineColor;
        Position = UDim2.new(0.204, 0, 0, 2);
        Size = UDim2.new(0.795, 0, 1, -4);
        ZIndex = 2;
        Parent = MainSectionInner;
    });
    ...
    function Window:AddTab(Name)
        ...
        local MainSide = Library:Create('ScrollingFrame', {
            BackgroundTransparency = 1;
            BorderSizePixel = 0;
            Position = UDim2.new(0, 0, 0, 0);
            Size = UDim2.new(1,0,1,0);
        ...
        MainSide:WaitForChild('UIListLayout'):GetPropertyChangedSignal('AbsoluteContentSize'):Connect(function()
            MainSide.CanvasSize = UDim2.fromOffset(0, MainSide.UIListLayout.AbsoluteContentSize.Y);
		end);
